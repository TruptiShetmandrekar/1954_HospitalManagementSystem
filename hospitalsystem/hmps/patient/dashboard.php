    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand" href="javascript:void(0)">
          <img src="assets/img/brand/medicare.png" class="navbar-brand-img" alt="...">
        </a>
      </div>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="list_doctors.php">
                <i class="ni ni-single-02 text-yellow"></i>
                <span class="nav-link-text">View List of Doctor</span>
              </a>
            </li>
             <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="Appointment_details.php">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Usr</li>
                </ol>
              </nav>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">take appointment</h5>
                      <p class="links cl-effect-1">
                        <a href="bookappointment.php">
                       
                        <p class="mt-3 mb-0 text-sm">

                      <span class="h2 font-weight-bold mb-0">Book Appointments</span>
                        </a>
                  ...
                  <div class="row">
                    <div class="col">
                     ...
                     <p class="links cl-effect-1">
                      ...
                      <span class="h2 font-weight-bold mb-0">Appointment History</span>
                        </a>
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              &copy; 2020 <a href="" class="font-weight-bold ml-1" target="_blank">MediCare</a>
            </div>
          </div>
          <div class="col-lg-6">
            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
              <li class="nav-item">
                <a href="" class="nav-link" target="_blank">MediCare</a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link" target="_blank">we</a>
              </li>
              <li class="nav-item">
                <a href="" class="nav-link" target="_blank">Care</a>
              </li>
              <li class="nav-item">
