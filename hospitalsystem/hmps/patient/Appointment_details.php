                ...
                <thead class="thead-light">
                  <tr>
                   <th scope="col">#</th>
                    ...
                    <tbody>
<?php
$sql=$conn->query("select doctors.doctorName as docname,appointment.*  from appointment join doctors on doctors.id=appointment.doctorId where appointment.userId='".$_SESSION['id']."'");
$cnt=1;
